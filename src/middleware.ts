...
const PUBLIC_ROUTES = ["/", "/login", "/signup", "/auth/callback", "/privacy", "/terms", "/api/health", "/api/payments/webhook", "/offline", "/reset-password", "/reset-password/confirm", "/colegios", "/api/school-leads", "/api/unsubscribe", "/contacto", "/api/contact"];
