...
export default async function TIPage({ searchParams }: { searchParams: { kid?: string; world?: string } }) {
  ...
  return <TranslateInverseRunner kid={kid} worldKey={searchParams.world} />;
}
